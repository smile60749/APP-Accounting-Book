...
public class p5 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Intent intentp25 = this.getIntent();
		Bundle bundlep25 = intentp25.getExtras();
		day = bundlep25.getInt("day");
	...
	private Button.OnClickListener l =new Button.OnClickListener(){
		...
		public void onClick(View arg0) {
			...
			{
				Cursor call=db.getAll();
				for(int i=1;i<=call.getCount();i++)
				{
					Cursor cc=db.getid(i);
					if(Integer.parseInt(cc.getString(1))==day)
					{
						long coco=Long.parseLong(cc.getString(3));
						sum=sum+coco;
					}
				}
				Toast.makeText(getApplicationContext(), day+"總共花費為"+sum+"元", Toast.LENGTH_SHORT).show();
			}
		}
	};
	private ListView.OnItemClickListener ol=new ListView.OnItemClickListener(){
		...
		public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
			...
			intent.setClass(p5.this, p4.class);
